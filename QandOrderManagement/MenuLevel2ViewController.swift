//
//  MenuLevel2ViewController.swift
//  Queue
//
//  Created by Kewalin Sakawattananon on 11/11/2558 BE.
//  Copyright © 2558 IBM. All rights reserved.
//

import UIKit

class MenuLevel2ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("menuListCell", forIndexPath: indexPath) as! MenuLevel2TableViewCell
        let menuList = menuListBySection[indexPath.section]!
        let menu = menuList[indexPath.row]
        cell.imgMenu.image = UIImage(named: menu.menu_picture)
